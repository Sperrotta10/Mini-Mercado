<template>
  <nav class="navbar">
    ...
    <ul class="nav_links">
      <li>
        <router-link to="/administrador" class="nav_item" exact-active-class="active">
      ...
      <li>
        <router-link to="/administrador/gestion_inventario" class="nav_item" active-class="active">
          <div class="nav_item_individual">
            ...
            <span class="text">Gestión Inventario</span>
          </div>
        </router-link>
      </li>
      <li>
        <router-link to="/administrador/gestion_empleado" class="nav_item" active-class="active">
          <div class="nav_item_individual">
            <i class="fa-solid fa-users"></i>
            <span class="text">Gestión Empleado</span>
          </div>
        </router-link>
      </li>
    </ul>
